...
**Subsequent gate failure:** [sampling every baked 30 Hz idle frame](dense-idle-contact-gate.md) finds three new nonadjacent contacts at frames 298–299, which were absent from the 73 selected poses. The measurements below remain valid for their original sample set, but this candidate now fails the denser animation gate and is not eligible for promotion.
