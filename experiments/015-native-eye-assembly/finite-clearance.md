...
25 September 2026. This is a **source-bound, offline geometry study**, not a rendered-eye acceptance. It extends the [57-joint assembly gate](README.md) using the exact installed 2.31 bound head GLB (`0f14804b80b279d28ab84503c9595292e20e0141eee959e67fc63b805f12f730`) and native eye GLB (`0e5420a75e5a65eded91bb68338860e119692f0868f78e7ef89c98c0c56eaeba`). Both hashes are enforced before sampling. The head has 7,186 vertices and 13,186 triangles; the native GLB supplies a 668-vertex eye surface, 12,393-vertex lash chunk and 152-vertex wetness chunk. The later [source-graph trace](source-graph-trace.md) found a matching `h091` native-eye morph and coordinated morph-specific joint binds that this checker did not apply. Its saved-pose contacts therefore compare **neutral eye with morphed head**, not game behavior. No production renderer, package, game, MO2 profile or user draft changed.
