...
The next discriminator, if this pose is pursued, is to determine whether the saved five-morph head and eye geometry are intended to receive another game-side corrective or animation/morph binding during the live character-creator blink. A game capture or an authoritative source graph for that correction would distinguish a real game issue from this offline assembly gap. This study does not justify changing Studio's renderer or moving an eye material into production.
