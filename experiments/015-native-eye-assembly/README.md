...
The [bounded private visual inspection](visual-inspection.md) now renders the exact native head and all eye/lash/wetness chunks at four selected phases with hash-gated source base maps and lash alpha. It confirms large exposed eye regions across the saved five-morph blink, whereas the neutral blink closes. The source brown gradient, native wetness/eye optical shader and live UI graph remain unresolved. Do not promote an eye material or alter Studio's renderer from this offline assembly: [the brown gradient's generated atlas/filter remains unknown](../014-native-eye-gradient/compiled-shader-and-gaze.md), the accepted plate is still absent, and the clean-user five-file intake has no native-eye slot. No extracted resource or render is committed or licensed for redistribution.
