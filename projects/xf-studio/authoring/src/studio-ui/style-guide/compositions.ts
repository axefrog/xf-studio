...
export function compositions() {
  const editing = `<div class="mock-shell">${mockHeader("Chrome dusk")}
    ...
    </div><footer class="status-bar"><span class="status-item">● Draft autosaved</span><span class="grow"></span><span class="status-item ready-badge" data-phase="ready">Preview 1K · ready</span></footer></div>`;
