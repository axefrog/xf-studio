...
export function panelSystem() {
  ...
  return section("panels", "03", "Panel system",
    ...
    pattern({ id: "d-sizes", title: "Size classes and default layouts", status: "implemented", wide: true,
      specimen: `<div class="layout-maps"><figure><div class="layout-map wide"><span style="grid-area:a">Presets · Library · Package</span><span style="grid-area:b">Layers</span><span style="grid-area:c" class="stage">Head</span><span style="grid-area:d" class="stage">UV map</span><span style="grid-area:e">Finish · Shape · Edge · Warp · Character · Light · Motion · Quality</span></div><figcaption>Wide (≥ 1100 px): stack · full-height head · UV map over the inspectors</figcaption></figure>
        <figure><div class="layout-map compact"><span style="grid-area:a" class="stage">Head</span><span style="grid-area:b" class="stage">UV map</span><span style="grid-area:c">Layers · Presets · Library · Package</span><span style="grid-area:d">Finish · Shape · Edge · Warp · Character · Light · Motion · Quality</span></div><figcaption>Compact (&lt; 1100 px): head beside the UV map, above two tab groups</figcaption></figure></div>`,
