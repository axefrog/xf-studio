...
const ICONS = {
  ...
  history: [s("M2.9 9.5A5.2 5.2 0 1 0 3.6 5"), s("M2.5 2.5v3h3"), s("M8 5.2v3l2 1.3")],
  ...
  body: [s("M8 1.5a1.6 1.6 0 1 0 0 3.2 1.6 1.6 0 0 0 0-3.2z"), s("M4 6.5h8M8 6v4.5M8 10.5l-2 4M8 10.5l2 4")],
  ...
  folder: [s("M1.5 4.5v8h13v-6.5H7.5L6 4.5z"), s("M1.5 4.5V3.5h4l1.5 1")],
  settings: [s("M2 4.5h7M12 4.5h2M2 11.5h2M7 11.5h7"), s("M10.5 3v3M5.5 10v3")],
