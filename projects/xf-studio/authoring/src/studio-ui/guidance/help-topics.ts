...
export const HELP_TOPICS: readonly HelpTopic[] = [
  ...
  { id: "character", title: "Your V in the preview", keywords: "save v character brows lashes hair eye shape load",
    body: "Load a save from the **Character** panel and the preview shows that V's own brows, lashes and hair, read from your game and mods. Your looks and library are never changed by loading a save.",
    tours: ["whats-new-0.1.0-alpha.1"] },
