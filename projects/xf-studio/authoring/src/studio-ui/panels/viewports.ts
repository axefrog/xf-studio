...
export function headPanel(rt: StudioRuntime): PanelController {
  ...
  // Quiet, overlaid status for the V's skin, face details, eyes, brows, lashes and hair: progress while they prepare, one plain line
  ...
  return {
    ...
    update(frame) {
      ...
      const detailText = state.phase !== "ready" || !details ? ""
        : details.phase === "preparing" ? "Preparing your V's skin, face details, eyes, brows, lashes and hair…"
