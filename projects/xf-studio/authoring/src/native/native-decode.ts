...
/** How a worker gets its decompressor: the game's Oodle library, or (tests only) a module export. */
export type WorkerDecompressor = { readonly gameRoot: string; readonly trustedSha256?: string } | { readonly module: string; readonly export: string };
