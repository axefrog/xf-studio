...
import { CHARACTER_FAMILY, COLLECTION_FAMILY, FILES_FAMILY, HISTORY_FAMILY, LIBRARY_FAMILY, MOTION_FAMILY, PREVIEW_FAMILY, QUALITY_FAMILY,
...
export const STUDIO_OWNERS = [HISTORY_FAMILY, EYE_MAKEUP, COLLECTION_FAMILY, PREVIEW_FAMILY, MOTION_FAMILY,
  QUALITY_FAMILY, SAVED_V_FAMILY, CHARACTER_FAMILY, LIBRARY_FAMILY, FILES_FAMILY] as const;
