 ...
 */
export type ProjectLink = "project-knowledge" | "project-issues" | "project-releases" | "blink-guide";
export const PROJECT_LINKS: Readonly<Record<ProjectLink, string>> = Object.freeze({
  ...
  // How the game's blink is prepared from the player's own game files (the Motion panel's note links it while it isn't).
  "blink-guide": "https://github.com/axefrog/xf-studio/blob/main/docs/idle-animation-guide.md#the-blink",
});
