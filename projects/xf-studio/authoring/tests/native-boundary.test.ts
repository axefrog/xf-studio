...
const HOST_ADAPTERS = ["archive-reader", "native-decode", "native-decode-worker", "native-fetch-port", "oodle"];
/** Modules outside src/native allowed to import it: the resolver host at integration (research/backlog/native-archive-reader.md). */
...
const HOST_IMPORTS = /^(?:node:(?:fs|child_process|os|worker_threads|net|http|https)|bun:ffi|bun)$|(?:^|\/)(?:archive-reader|native-decode|native-decode-worker|native-fetch-port|oodle|resolver-host|process-tree|wolvenkit-cli)$/;
