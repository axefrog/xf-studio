...
import { initialRecipe, parseRecipe, raster, type Recipe } from "../src/engines/layered-makeup/recipe";
import { applyRecipeAction } from "../src/engines/layered-makeup/recipe-actions";
