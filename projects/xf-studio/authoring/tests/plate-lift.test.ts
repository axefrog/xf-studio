...
import { VERIFIER_PLATE_LIFT_MM } from "../src/features/eye-makeup/verify/plate-geometry";
import { VERIFIER_SURFACE_RANGES } from "../src/features/eye-makeup/verify/resource-checks";
