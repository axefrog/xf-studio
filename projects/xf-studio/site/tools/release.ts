...
${[
  ...
  step("04 · Your game", "No game files included", "The editor, library and export Check work without any game files. The 3D preview and building mod files need resources prepared from your own copy of the game."),
].join("\n")}
    </ol>
${fromSource(blob)}
  </div>
...
${[
  ...
  step("04 · First run", "Start without game files", "Skip setup to go straight to the flat UV editor, library and export Check. Add preview files prepared from your own copy of the game later for the 3D head; nothing from the game is included."),
].join("\n")}
    </ol>
${fromSource(blob)}
  </div>
