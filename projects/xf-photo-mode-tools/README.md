...
Status: independent peer project in research. XF Studio eye makeup is the current implementation priority; new Photo Mode Tools work belongs here.
...
Use a project-local `src`, `data`, `resources`, `build`, `dist` layout when implementation begins. No shared all-in-one toolbox is required.
