...
@media (max-width: 1000px) { .guide-layout { grid-template-columns: 1fr; padding: var(--sp-5); } .guide-toc { display: none; } .patterns { grid-template-columns: 1fr; } .specimen.compare { grid-template-columns: 1fr; } }
`;
