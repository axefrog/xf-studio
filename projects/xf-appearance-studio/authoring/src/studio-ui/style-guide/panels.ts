...
export function panelSystem() {
  ...
  return section("panels", "03", "Panel system",
    ...
    pattern({ id: "d-sizes", title: "Size classes and default layouts", status: "implemented", wide: true,
      specimen: `<div class="layout-maps"><figure><div class="layout-map wide"><span style="grid-area:a">Presets · Library · Package</span><span style="grid-area:b">Layers</span><span style="grid-area:c" class="stage">Head</span><span style="grid-area:d" class="stage">UV map</span><span style="grid-area:e">Colour &amp; finish</span><span style="grid-area:f">Shape · Pigment &amp; edge · Warp</span><span style="grid-area:g">Character · Camera &amp; light · Motion · Quality</span></div><figcaption>Wide (≥ 1100 px): stack · stage · inspector</figcaption></figure>
        <figure><div class="layout-map compact"><span style="grid-area:a" class="stage">Head · UV map</span><span style="grid-area:b">Layers · Presets · Library · Package</span><span style="grid-area:c">Finish · Shape · Edge · Warp · Character · Light · Motion · Quality</span></div><figcaption>Compact (&lt; 1100 px): stage above two tab groups</figcaption></figure></div>`,
      ...
      when: "Design new panels for both: say which default group they join in each size class.",
