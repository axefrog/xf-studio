...
The authoring prototype supports weighted curve areas, a Gaussian vector field, symmetry, editable ordered layers, colour/finish studies, recipe persistence, 2K alpha-mask export, exploratory eyelid motion and importing a save's facial morph choices. It renders the actual head and `.010` plate with eight bone influences and all 105 customization morphs. Optional Arkhe brows, Soft Natural lashes and a locally resolved saved-V MELUMINARY hair mesh provide preview context; hair only appears for an exact saved appearance match. Materials, hair physics and blink remain approximate, and saved skin/other appearance references are not yet a complete likeness. Direct face dragging for curve/field controls is now implemented; remaining authoring refinements are in the [persistent queue](../../research/backlog/eye-artistry-authoring.md). See [save research](../../research/eye-artistry/save-import.md) and [hair preview limits](../../research/eye-artistry/saved-v-hair-preview.md).
