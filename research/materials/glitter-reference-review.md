...
Sources: [`finish.ts`](../../projects/xf-appearance-studio/authoring/src/finish.ts), [`makeup-stack.ts`](../../projects/xf-appearance-studio/authoring/src/makeup-stack.ts), and the installed Three.js shader chunks named below.
