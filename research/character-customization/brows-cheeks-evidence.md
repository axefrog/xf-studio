...
| `…/archivexl-character-creator-additions/README.md` | manavortex and redacted-c01; edit by icxrus | Vanilla switcher table: `makeupCheeks` (switcher) and `makeupCheeks_color` (appearance slot), `eyebrows`/`eyebrows_color`; recommends extending established switchers | – |
