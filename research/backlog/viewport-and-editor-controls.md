...
- **Pan:** support and explain practical viewport panning, especially when a narrow viewport crops the editing region. Inspect current OrbitControls bindings, preserve target/camera together and persist framing. Do not confuse orbit with pan or break direct surface dragging. Consider a visible mode/gesture hint in addition to the mouse shortcut.
