...
This sits under [preview fidelity](preview-fidelity.md) (track 2) and [materials RE](materials-shader-re.md) (track 4). It is research authorization, not an assumption that a rewrite is justified. Keep rendering adapters separate from authoring/domain logic so the later UI overhaul remains independent.
