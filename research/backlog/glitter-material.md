...
1. Use the [finish board](../../experiments/016-finish-board/README.md) and [experiment 017](../../experiments/017-plate-depth/README.md) sessions to tune or withdraw the experimental Glossy, Shimmer and Colour-shifting adapters. Glitter's next candidate is the resolved glint-flake route ([design](../materials/finish-designs/glitter.md)). Build its diagnostic board ([experiment 018](../../experiments/018-glitter-route/README.md#diagnostic-board)) once merges resume. Offline checks first: V sign of the UV window, BC5 on 3-texel flakes, supplied chains for non-square maps.
2. **Plate texel density affects every finish.** The plate samples 4 % of each preset texture. Decide whether flat, faceted and Fresnel routes should also move to the plate-local UV window: sharper edges and finer Shimmer at the same texture memory ([texel density](../../experiments/018-glitter-route/README.md#texel-density)).
