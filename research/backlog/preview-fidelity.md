...
Preview-quality request, 23 September: configurable in-studio makeup texture resolution, investigate 512/1024/2048/4096 tiers and expose a collapsible Preview quality group beside lighting for now. Keep saved preview preferences separate from portable authored content and eventual game-export resolution. This group can later host renderer quality options. Audit mask, optical-map, GPU upload and memory costs rather than changing a single canvas or upscaling native game textures.
