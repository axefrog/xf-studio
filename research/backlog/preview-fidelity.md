...
| Render **all** CC details | **Open.** Currently: head and skin (resolved for any V since P1), expanded plate, eyes (resolved for any V: iris colour and wetness shell, eye plan ranks 1–3), brows, lashes and hair (resolved for any V since P0; [head CC rendering](../../knowledge/head-cc-rendering.md#6-render-plan-ranked-by-visual-gain-per-effort)), vanilla/PRC piercings. Missing or approximate: head decals (makeup, lips, cheeks, scars, tattoos, cyberware), teeth/mouth parts, the eye's refraction and Eye-class light, layered eye designs, other CC categories. Depends on [materials RE](materials-shader-re.md) and [CC controls](cc-controls-and-presets.md). |
| 1. Resolve the actual modded eyes | **Done through the resolver (eye plan ranks 1–3).** Any vanilla or CCXL eye colour of the shown V resolves on the launch route, with no per-mod code. That includes the reference save's Kala eye (through Unique Eyes to CCXL, from a hash-only archive) and a new-game save's gradient light blue. Gradient irises use the resolved colour ramp, every eye is sampled V-flipped as the game does, and the wetness shell darkens the corners and adds the tear line. Layered designs fall back to the default eye with a plain line. **Open:** refraction and the two-normal Eye light (ranks 4–5), heterochromia (6) and layered designs (7), then test asks 9–12. [Eye rendering §6.6](../../knowledge/eye-rendering.md#66-implementation-status-ranks-13-built-ranks-47-open) [Resolution](../eye-artistry/modded-eye-resolution.md), [optics audit](../eye-artistry/eye-lip-optics-audit.md) |
