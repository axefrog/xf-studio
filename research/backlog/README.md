...
|---|---|---|
| 1 | XF Appearance Studio makeup material/mesh proof | Next implementation slice; see project README and validation plan |
| 2 | [CCXL and character-creator capability map](ccxl-character-creator-capabilities.md) | Explicitly requested by Nathan on 2026-09-23; queued. Pull forward its palette/UI findings when they unblock XF Appearance Studio. |
| 3 | Photo Mode Tools engine/API audit | After Appearance Studio's first makeup completion milestone; see project README |
| Required for XF Appearance Studio | [Makeup finish families and glitter](glitter-material.md) | Seven recognizable finish families; prove mixed-finish preset compilation and game/browser effects. |
...
The first [XF Appearance Studio](../../projects/xf-appearance-studio/authoring/README.md) now provides concrete exploratory work. Continue game-material adaptation, authentic blink extraction, richer procedural control, and [saved-V resource resolution](../eye-artistry/save-import.md). The decoded save is a useful input to the CCXL boundary study. Old Eye Artistry content/identities may be discarded; legacy parity is not required.
