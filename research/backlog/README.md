...
| 2 | **Character detail rendering completeness** — brow, lash and hair *colours* correct first (a long-standing, top feature priority), then render **all** character-customisation details in the viewport | Open. Brows, lashes, hair, skin, eyes and face details (rank 2 of the head CC plan) render from the resolver's output for any V; since 26 September (`claude/body-render`) so does the vanilla body (step 4 of the standing direction: body, arms, hands, nails, feet, body tattoos and scars and the game's underwear cover, on the idle rig, with a toggle and a whole-body view). Parity with the game not yet measured. Next: worn clothing (step 5). A masculine V is catalogued but not drawn or exported; the [masculine V plan](../character-customization/male-v-plan.md) phases it (core head, idle, beard, body, then his own eye plate and a `male:` selector sharing the feminine textures). | [Head CC rendering plan](../../knowledge/head-cc-rendering.md), [body rendering](../../knowledge/body-rendering.md) (ranked: resolver-fed render record, skin material, one face-decal path, creator controls, full eye, general hair), [preview fidelity](preview-fidelity.md), [brow/lash study](../eye-artistry/brow-lash-fidelity.md), [hair profile resolution](../eye-artistry/saved-hair-profile-resolution.md) |
...
| 4 | **Materials system and shader reverse-engineering** — skin, hair, eye, decal/multilayered and related shaders | Reference phase complete (26 September): skin, hair, eye, decal and multilayered references and the shader fact index. Next: the ranked follow-ups in the track page, led by the glitter accent's `EmissiveEV`, Colour-shifting's metalness and a tilt-floor Shimmer. *Parallel*. | [Materials and shader RE](materials-shader-re.md) |
