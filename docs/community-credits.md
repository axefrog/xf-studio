...
**Use as of this entry:** documentation/source study only; integration and fidelity verification are still pending. No solver code has been copied into the studio. Track subsequent execution/adaptation explicitly here. This informs the active character-creator idle investigation and the [animation feature queue](../research/backlog/eye-artistry-authoring.md).

### Cyberpunk 2077 Modding Wiki — community authors and editors

[Documentation repository](https://github.com/CDPR-Modding-Documentation/Cyberpunk-Modding-Docs) and [wiki](https://wiki.redmodding.org/cyberpunk-2077-modding). Individual page authors are not yet resolved; credit the contributor community rather than attributing everything to one person.
