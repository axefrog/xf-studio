...
| [redscript-cli](https://github.com/jac3km4/redscript/releases/tag/v0.5.31) | 0.5.31 | Offline type check of the bridge's redscript layer against a copy of the game's `final.redscripts` (`tools/lint-redscript.ts`) | `D:/Dev/tools/redscript-cli/0.5.31/` (GitHub-published SHA-256 verified); `XFB_REDSCRIPT_CLI` |
