...
A "creator lighting" stage preset for the Studio. Today the preview uses ACES filmic at exposure 1.2, Three's `RoomEnvironment` image-based lighting and two directional lights (`src/scene.ts`); none of those belong in this preset.
