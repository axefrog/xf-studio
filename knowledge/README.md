...
|---|---|---|---|
| Resource formats and the character-customisation file chain (`.inkcharcustomization` → `.app` → `.ent` → `.mesh` / `.morphtarget` → materials) | [cc-file-chain.md](cc-file-chain.md) | Draft | [File-chain map](../research/character-customization/file-chain-map.md), [CCXL merge boundary](../research/character-customization/ccxl-merge-boundary.md), [catalogue prototype](../research/character-customization/catalog-prototype.md), [mod source resolution](../research/character-customization/mod-source-resolution.md), [head details](../research/eye-artistry/head-details.md), [built-in eye plate](../experiments/012-native-plate-bootstrap/README.md#built-in-production-plate) (byte-level `.mesh` render-blob and `.morphtarget` diff/mapping layout as used by [`eye-plate-cut.ts`](../projects/xf-studio/authoring/src/eye-plate-cut.ts)), legacy xf-omega / `xf-eye-artistry-ccxl` code (reference only) |
...
| Mod loading and resource precedence (archive load order, ArchiveXL/TweakXL, MO2 VFS) | `mod-loading.md` (to write) | Seed | [ArchiveXL strategy](../research/archive-xl/eye-artistry-strategy.md), [brown liquorice overlap](../research/eye-artistry/brown-liquorice-profile-overlap.md), [framework diagnostic profile](../research/authoring/framework-diagnostic-profile-2026-09-25.md), [source discovery and MO2 precedence](../research/authoring/source-discovery-foundation.md) (first `modlist.txt` row wins; install/instance detection), [framework check and MO2 placement](../research/authoring/framework-version-check.md) (framework version sources; separators head the rows above them in `modlist.txt`; unlisted mod folders get top priority) |
